        ...
        <div className="container mx-auto p-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md w-1/2 mx-auto">
                <div className="flex flex-col gap-4">
                    ...
                    <FormInput invalidFields={invalidFields} setInvalidFields={setInvalidFields} label={'Số điện thoại'} value={payload.SDT} setValue={setPayLoad} keyName="SDT" type="text" readOnly={false} />
                    <FormInput invalidFields={invalidFields} setInvalidFields={setInvalidFields} label={'Tên người dùng'} value={payload.hoTen} setValue={setPayLoad} keyName="hoTen" type="text" readOnly={false} />
                    <FormInput
                        invalidFields={invalidFields}
                        setInvalidFields={setInvalidFields}
