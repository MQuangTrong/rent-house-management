...
const AddRoom = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await services.apiAddRoom(roomDetails)
            console.log(response);
            if (response.data.err === 0) {
                if (response.data.msg.includes("Thêm mới phòng thành công")) {
    ...
    return (
        <div className="container mx-auto w-3/4">
            <h2 className="text-2xl font-bold mb-4">Thêm Phòng Trọ</h2>
